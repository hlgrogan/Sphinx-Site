...
Add a PayPal Buy Now Button to your website and start selling today. No Coding Required. Official PayPal Partner.

== Description ==
= Overview =

This plugin will allow you to sell products or services on your website using a PayPal Buy Now Button.
...
*	Button Inserter - Just enter your items name, price, etc. and it make the Buy Now button for you
...
>
>
> [You can learn more about the Pro version here](https://wpplugin.org/easy-paypal-button/)
